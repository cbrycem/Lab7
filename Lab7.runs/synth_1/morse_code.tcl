...
synth_design -top morse_code -part xc7a35tcpg236-1
...
write_checkpoint -force -noxdef morse_code.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file morse_code_utilization_synth.rpt -pb morse_code_utilization_synth.pb"  } 
