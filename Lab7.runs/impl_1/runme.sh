...
HD_PWD='C:/Users/cbrycem/Desktop/Vivado/Lab0/Lab7/Lab7.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_code.tcl -notrace
